...
with tab2:
    ...
    st.markdown("HARISS uses a Convolutional Neural Network to predict the shape of a population distribution from a sample distribution histogram. It has been trained to analyze data distribution histograms from samples of sizes ranging from 20 to 40 individuals. The 95% confidence interval provided is built according to the method described in [Coisnon et al](https://onlinelibrary.wiley.com/doi/abs/10.1111/vcp.13000). The 90% confidence interval of each estimated limit is calculated based on 200 bootstrap iterations.")
